...
function action(fileName) {
        ...
        processNGRDI(originalID, fileName);
        processTGI(originalID);
        processResults(imageName);
}
...
*/
function processNGRDI(originalID, imageName) {
...
*/
function processTGI(originalID) {
...
function processResults(imageName) {
